...
public class Principal {
    ...
    public void guardarLibroEnBaseDeDatos(DatosLibros datosLibros) {
        // Metodo para verificar si el libro ya existe en la base de datos
        ...
        if (libroExistente != null) {
            ...
            // Busqueda y guardado de autores
    ...
    //  método para mostrar todos los libros buscados/registrados
